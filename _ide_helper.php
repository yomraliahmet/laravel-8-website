 ...
 */
     ...
     */ 
         ...
         * @static 
         */ 
        public static function redirectToJson($url, $data = [], $status = 200, $headers = [], $options = 0)
        {
                        return \Illuminate\Routing\ResponseFactory::redirectToJson($url, $data, $status, $headers, $options);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function success($message = null, $data = [], $status = 200, $headers = [], $options = 0)
        {
                        return \Illuminate\Routing\ResponseFactory::success($message, $data, $status, $headers, $options);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function error($message = null, $data = [], $status = 400, $headers = [], $options = 0)
        {
                        return \Illuminate\Routing\ResponseFactory::error($message, $data, $status, $headers, $options);
        }
...
')
     ...
     */ 
         ...
         * 
         *
         * @see \App\Providers\ButtonServiceProvider::boot()
         * @param string $url
         * @param array $permission
         * @param array $options
         * @static 
         */ 
        public static function backButton($url, $permission = [], $options = [])
        {
                        return \Collective\Html\HtmlBuilder::backButton($url, $permission, $options);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function submitButton($url, $permission, $options = [])
        {
                        return \Collective\Html\HtmlBuilder::submitButton($url, $permission, $options);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function ajaxSubmitButton($form, $permission, $options = [])
        {
                        return \Collective\Html\HtmlBuilder::ajaxSubmitButton($form, $permission, $options);
        }
