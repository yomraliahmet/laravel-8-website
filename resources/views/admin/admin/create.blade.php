...
@section("content")
    ...
    <x-card :title="$title" :buttons="$buttons" icon="fa fa-edit"  type="default">
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <img class="preview" width="100%" height="auto" src="{{ url("/assets/backend/images/noimage.png") }}" alt="">
            ...
            <div class="col-md-10">
                <div class="createForm">
                    {!! Form::open(['id' => 'form', 'class' => 'ajax reset', 'route' => 'admin.admin.store', 'method' => 'post']) !!}
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                {!! Form::select('roles[]',$roles,null, ["id" => "roles","class" => "form-control select2", "multiple" => "multiple"]); !!}
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
