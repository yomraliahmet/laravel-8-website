...
@section("content")
    <div class="row">
        ...
        <div class="col-md-6 order-md-2">
            <x-card :title="$newtitle" :buttons="$buttons" icon="fa fa-plus"  type="default">
                <div class="createForm">
                    {!! Form::open(['id' => 'form', 'class' => 'ajax reset', 'route' => 'admin.menu.store', 'method' => 'post']) !!}
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            {!! Form::text($locale.'[name]' , null, ["id" => $locale."_name","class" => "form-control", "placeholder" => trans("models.menu.name")]); !!}
