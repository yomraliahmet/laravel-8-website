...
<head>
    ...
    <!-- Bootstrap -->
    <link type="text/css" rel="stylesheet" href="{{ url('/') }}/theme/css/bootstrap.min.css"/>

    <!-- Slick -->
    <link type="text/css" rel="stylesheet" href="{{ url('/') }}/theme/css/slick.css"/>
    <link type="text/css" rel="stylesheet" href="{{ url('/') }}/theme/css/slick-theme.css"/>

    <!-- nouislider -->
    <link type="text/css" rel="stylesheet" href="{{ url('/') }}/theme/css/nouislider.min.css"/>

    <!-- Font Awesome Icon -->
    <link rel="stylesheet" href="{{ url('/') }}/theme/css/font-awesome.min.css">

    <!-- Custom stlylesheet -->
    <link type="text/css" rel="stylesheet" href="{{ url('/') }}/theme/css/style.css"/>
...
<header>
    <!-- TOP HEADER -->
    @include("web.template.top-header")
    <!-- /TOP HEADER -->

    <!-- MAIN HEADER -->
    @include("web.template.main-header")
    <!-- /MAIN HEADER -->
</header>
<!-- /HEADER -->
...
<script src="{{ url('/') }}/theme/js/nouislider.min.js"></script>
