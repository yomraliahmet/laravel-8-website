...
@section('content')
    ...
    <div id="breadcrumb" class="section">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h3 class="breadcrumb-header">{{ trans("web.user.title") }}</h3>
                    <ul class="breadcrumb-tree">
                        <li><a href="{{ url("/") }}">{{ trans("web.common.home") }}</a></li>
                        <li class="active">{{ trans("web.user.title") }}</li>
                    </ul>
                </div>
            </div>
            <!-- /row -->
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="panel panel-default">
                        <h4 class="panel-heading">{{ trans('web.user.title') }}</h4>
                        <div class="panel-body">

                            {!! Form::model($user,['route' => 'web.register', 'id' => 'register-form', 'onsubmit' => 'return false;']) !!}
                            <div class="row">
                                <div class="form-group col-md-12 mb-4">
                                    {!! Form::text('fullname', null, ['class' => 'form-control', 'disabled', 'placeholder' => trans('web.register.fullname'), 'autocomplate' => 'off']) !!}
                                </div>
                                <div class="form-group col-md-12 mb-4">
                                    {!! Form::email('email', null, ['class' => 'form-control', 'disabled', 'placeholder' => trans('web.register.email'), 'autocomplate' => 'off']) !!}
                                </div>
                                <div class="form-group col-md-12 ">
                                    {!! Form::password('password', ['class' => 'form-control', 'disabled', 'placeholder' => trans('web.register.password')]) !!}
                                </div>
                            </div>
                            {!! Form::close() !!}
                ...
                <div class="col-md-6">
                    <div class="panel panel-default">
                        <h4 class="panel-heading">{{ trans("web.user.address_title")  }}</h4>
                        <div class="panel-body">
